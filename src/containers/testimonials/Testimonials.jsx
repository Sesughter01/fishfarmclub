           ...
           <div className="fishfarmclub__testimonials" id='features'>
               <div className="fishfarnclub__testimonials-feature">
                   <div className="card_1">
                     <Feature props = {allImages[1] } content = "Also make money from referals. Our unique platform handles all referals to ensure  we know who you refer to us.."/>

                   </div>
                   <div className="card_2">
                       <Feature props = {allImages[0]} content = "Start building a new income stream today. Fishfarmclub is renowned for its industry leading team collaboration tools." />
